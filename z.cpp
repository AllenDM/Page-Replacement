...
void belady(list<int> &list, deque<int> &deque, int streamCount, deque<int> &refStream, int frameCount){
...
void lru(list<int> &list, deque<int> &deque, int streamCount, deque<int> &refStream, int frameCount){
    bool isInQueue = false;
    int replacementVal;
    int pageFaultCount = 0;
    int recentlyUsed;
...
void fifo(deque<int> &deque, queue<int> &queue, int streamCount, deque<int> &refStream, int frameCount){
    bool isInQueue = false;
    int replacementVal;
    int pageFaultCount = 0;
